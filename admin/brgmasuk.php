  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="brgmasuk.php">STO</a></li>
	...
	<div class="row">
		<form class="form-horizontal" role="form" action="" method="POST">
			<div class="col-md-5">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="idsto">Kode Jual</label>
					<div class="col-sm-8">
						<?php
						...
						echo'
						<input class="form-control" type="text" readonly name="idsto" value="'.$kode_otomatis.'"></td>';
						?>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-4" for="tgl">Tanggal STO</label>
					<div class="col-sm-8">
			...
			<div class="col-sm-5">
				<!-- InPUt Buku ??? -->
				<div class="form-group">
					<label class="control-label col-sm-4" for="idbuku">Id Buku</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="qty">Jumlah STO</label>
					<div class="col-sm-8">
		...
		<form  action="savesto.php" method="post">
		...
		<table>
			...
			if (@$_POST["namabuku"]!=''){
				...
				//@$xx=$xx+$sub;
				$_SESSION["akhir"][$_SESSION["isi"]]=array($NamaBuku,$HargaBuku,$Stock,$sub,$KodeBuku);
			}//else{
